...
\begin{proof}
	...
	\caption{An example of the situation in \cref{lemma:treeEquivClass-intVertices}.
        We have two paths $Q$ (in blue) and $P$ (in red) from $x$ to $y$.
        We assume that the fastest temporal path from $z_1$ to $y$ is $P_1 = \{z_1 u\} \cup P$,
		and the fastest temporal path from $z_2$ to $y$ is $Q_2 = \{z_2 x\} \cup Q$.
        %
        ...
        The labels on the edges $z_1 x, z_2 x$ are $t_1,t_2$, respectively. Similar, the labels of the last edges of paths $P$ and $Q$ are  $t_p, t_q$, respectively.
