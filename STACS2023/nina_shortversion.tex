...
\begin{itemize}
    ...
    \item We show that we can determine most labels along each path. We show that the number of labels we cannot determine is small. 
    \item For each non-determined label we introduce a variable for an ILP.
