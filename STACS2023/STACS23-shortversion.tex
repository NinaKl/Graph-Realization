...
Unfortunately the above guesses do not provide us with enough information to be able to determine all fastest paths. For example consider the case depicted in \cref{fig:guesses-advanced}. 
