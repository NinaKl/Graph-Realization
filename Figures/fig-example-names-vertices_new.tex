...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\node [vert, fill = blue] (1) at (-12.25, 0) {};
		\node [vert, fill = green] (2) at (-10.75, 0) {};
		...
		\node [vert, fill = green] (11) at (-8, 2.25) {};
		\node [vert, fill = blue] (12) at (-10.25, 2.25) {};
		...
		\node [vert, fill = blue] (20) at (-11.25, 2.25) {};
		...
		\node [vert, fill = green] (27) at (-10.5, 1) {};
