...
\node[rotate=-90] (A) at (7,-18) {verification gadget for $i$};
    ...
    \node[vert,label=left:$v_{i,j}^{\star\star}$, fill=gray] (VSS) at (-4,-24.5) {};
    ...
    \draw[edge] (VH11) --node[timelabel,sloped] {$n^6$} (VH12);
	\draw[edge] (VH12) --node[timelabel,sloped] {$n^6+1$} (VH111);
	\draw[edge] (VH12) --node[timelabel] {$n^6+1$} (VH13);
    \draw[edge] (VH13) --node[timelabel,sloped] {$n^6$} (VH14);
	\draw[edge] (VH13) --node[timelabel,sloped] {$n^6+1$} (VH144);
	
    \draw[edge] (VH21) --node[timelabel,sloped] {$n^6$} (VH22);
	\draw[edge] (VH22) --node[timelabel,sloped] {$n^6+1$} (VH211);
	\draw[edge] (VH22) --node[timelabel] {$n^6+1$} (VH23);
    \draw[edge] (VH23) --node[timelabel,sloped] {$n^6$} (VH24);
	\draw[edge] (VH23) --node[timelabel,sloped] {$n^6+1$} (VH244);
 
    \draw[edge] (VH31) --node[timelabel,sloped] {$n^6$} (VH32);
	\draw[edge] (VH32) --node[timelabel,sloped] {$n^6+1$} (VH311);
	\draw[edge] (VH32) --node[timelabel] {$n^6+1$} (VH33);
    \draw[edge] (VH33) --node[timelabel,sloped] {$n^6$} (VH34);	
    \draw[edge] (VH33) --node[timelabel,sloped] {$n^6+1$} (VH344);
	...
	\draw[edge] (VH11) --node[timelabel] {$n^6$} (W2);
	\draw[edge] (VH21) edge[bend left=50] node[timelabel] {$n^6$} (W3);
	\draw[edge] (VH31) --node[timelabel] {$n^6$} (W4);
...
\begin{claim}\label{claim:2}
    ...
    %\begin{itemize}
        ...
        %\item For all $v\in V^\star$ we have $n^6\le \lambda(\{\hat{v}_1,v\}), \lambda(\{\hat{v}_2,v\})\le n^6+2$.
        %\item For all $v\in A\setminus B$ we have $\lambda(\{\hat{v}_1,v\})=n^6$ and $\lambda(\{\hat{v}_2,v\})=n^6+2$.
        %\item For all $v\in B$ we have $\lambda(\{\hat{v}_1,v\})=n^6$ and $\lambda(\{\hat{v}_2,v\})=n^6$.
        %\item 
...
%Furthermore, if $v\in B$ then we also have $d(\hat{v}_0,v)=\infty$ and it follows that $\lambda(\{\hat{v}_1,v\})=n^6$.
%If $v\notin B$ then we have $d(\hat{v}_0,v)=3$ and it follows that $\lambda(\{\hat{v}_1,v\})=n^6+2$ or $\lambda(\{\hat{v}_2,v\})=n^6+2$.
\end{claimproof}
...
By the construction it follows that $Z$ consists of disjoint trees. %%TBDNKL
