...
In the first step of the algorithm we create an instance $D'$, with the underlying graph $G'$, from $D$ and $G$, by iteratively removing vertices of degree one from $G$ and their corresponding rows and columns from the matrix $D$. 
