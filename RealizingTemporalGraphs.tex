...
\begin{claim}\label{claim:2}
    ...
    \begin{itemize}
        ...
        \item For all $v\in V^\star$ we have $\lambda(\{\hat{v}_1,v\})\ge n^5$ and $\lambda(\{\hat{v}_2,v\})\ge n^5$.
        ...
        %\item For all $v\in V^\star \setminus A$ we have $\lambda(\{\hat{v}_1,v\})=n^5+2$ and $\lambda(\{\hat{v}_2,v\})=n^5$.
    \end{itemize}
\end{claim}
\begin{claimproof}
