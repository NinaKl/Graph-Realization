...
\begin{itemize}
    \item We set $d(\hat{v}_0,\hat{v}_2)=2$.
...
\end{itemize}
Now consider two connector gadgets, one with vertices $\hat{v}_0,\hat{v}_1,\hat{v}_2$ and with sets $A$ and $B$, and one with vertices $\hat{v}_0',\hat{v}_1',\hat{v}_2'$ and with sets $A'$ and $B'$.
\begin{itemize}
...
\begin{itemize}
    ...
    \item We set $d(w,\hat{v}_1)=n^5-6(i+j)+1$ and $d(w,\hat{v}_2)=n^5-6(i+j)+1$.
    \item For each vertex $v\in (V^\star\cup \hat{V})\setminus (X_{i,j}\cup \{v_{i,j}^{\star\star}\})$ we set $d(w,v)=n^5-6(i+j)+3$.
\end{itemize}
Let $\hat{v}_1$ belong to some connector gadget. Then we set $d(w^\star,\hat{v}_1)=n^5$.

All distances between non-adjacent vertex pairs that are not specified above are set to infinity.

\begin{figure}%[t]
\begin{center}
\begin{tikzpicture}[line width=1pt, scale=.7]
\footnotesize
\draw[rounded corners, dashed, gray] (-13, 5) rectangle (8, 1.5) {};
\node (A) at (-10.5,4.5) {alignment gadget};

\draw[rounded corners, dotted, gray] (-12, -2.5) rectangle (-10, -7.5) {};
\draw[rounded corners, dotted, gray] (-12, -10.5) rectangle (-10, -15.5) {};
\draw[rounded corners, dotted, gray] (7, -2.5) rectangle (9, -7.5) {};
\node[rotate=90] (A) at (-12.5,-13) {connector gadget};

\draw[rounded corners, dashed, gray] (-9.5, 1) rectangle (1.5, -27) {};
\node (A) at (-4,-26) {edge selection gadget for $i,j$};

\draw[rounded corners, dashed, gray] (3.5, 1) rectangle (6.5, -27) {};
\node[rotate=-90] (A) at (7,-18) {verification gadget for $i$};
    ...
    \node[vert,label=left:$\hat{v}_1$, fill=gray] (VH12) at (-11,-5) {}; 
    \node[vert,label=left:$\hat{v}_2$, fill=gray] (VH13) at (-11,-7) {}; 

    \node[vert,label=left:$\hat{v}_0$] (VH21) at (-11,-11) {}; 
    \node[vert,label=left:$\hat{v}_1$, fill=gray] (VH22) at (-11,-13) {}; 
    \node[vert,label=left:$\hat{v}_2$, fill=gray] (VH23) at (-11,-15) {};

    \node[vert,label=right:$\hat{v}_0$] (VH31) at (8,-3) {}; 
    \node[vert,label=right:$\hat{v}_1$, fill=gray] (VH32) at (8,-5) {}; 
    \node[vert,label=right:$\hat{v}_2$, fill=gray] (VH33) at (8,-7) {}; 
    ...
    \node[vert,label=left:$y_1$] (Y1) at (-8,-6) {}; 
    \node[vert,label=left:$y_2$] (Y2) at (-6,-6) {}; 
    \node[vert,label=left:$y_3$] (Y3) at (-4,-6) {}; 
    \node (A) at (-2,-6) {$\ldots$};
    \node[vert,label=right:$y_m$] (YM) at (0,-6) {}; 

    \node[vert,label=left:$u^1_1$] (U11) at (-8,-8) {}; 
    \node[vert,label=left:$u^1_2$] (U12) at (-6,-8) {}; 
    \node[vert,label=left:$u^1_3$] (U13) at (-4,-8) {}; 
    \node (A) at (-2,-8) {$\ldots$};
    \node[vert,label=right:$u^1_m$] (U1M) at (0,-8) {};
    
    \node[vert,label=left:$u^2_1$] (U21) at (-8,-10) {}; 
    \node[vert,label=left:$u^2_2$] (U22) at (-6,-10) {}; 
    \node[vert,label=left:$u^2_3$] (U23) at (-4,-10) {}; 
    \node (A) at (-2,-10) {$\ldots$};
    \node[vert,label=right:$u^2_m$] (U2M) at (0,-10) {};
    ...
    \node[vert,label=left:$u^n_1$] (UN1) at (-8,-13) {}; 
    \node[vert,label=left:$u^n_2$] (UN2) at (-6,-13) {}; 
    \node[vert,label=left:$u^n_3$] (UN3) at (-4,-13) {}; 
    \node (A) at (-2,-13) {$\ldots$};
    \node[vert,label=right:$u^n_m$] (UNM) at (0,-13) {};

    \node[vert,label=left:$u^{n+1}_1$] (UN11) at (-8,-17) {}; 
    \node[vert,label=left:$u^{n+1}_2$] (UN12) at (-6,-17) {}; 
    \node[vert,label=left:$u^{n+1}_3$] (UN13) at (-4,-17) {}; 
    \node (A) at (-2,-17) {$\ldots$};
    \node[vert,label=right:$u^{n+1}_m$] (UN1M) at (0,-17) {};
    ...
    \node[vert,label=left:$u^{2n}_1$] (U2N1) at (-8,-20) {}; 
    \node[vert,label=left:$u^{2n}_2$] (U2N2) at (-6,-20) {}; 
    \node[vert,label=left:$u^{2n}_3$] (U2N3) at (-4,-20) {}; 
    \node (A) at (-2,-20) {$\ldots$};
    \node[vert,label=right:$u^{2n}_m$] (U2NM) at (0,-20) {};
    
    \node[vert,label=left:$v_{i,j}^\star$, fill=gray] (VSS) at (-4,-24.5) {};


    \node[vert,label=right:$v_0^i$, fill=gray] (VI0) at (5,0) {};
    \node[vert,label=right:$v_1^i$, fill=gray] (VI1) at (5,-3) {};
    \node (A) at (5,-5) {$\vdots$};
    \node[vert,label=right:$v_{j-1}^i$, fill=gray] (VIJ1) at (5,-7) {};
    \node[vert,label=right:$v_{j}^i$, fill=gray] (VIJ) at (5,-11) {};
    \node (A) at (5,-13) {$\vdots$};
    \node[vert,label=right:$v_{i-1}^i$, fill=gray] (VII1) at (5,-15) {};
    \node[vert,label=right:$\hat{u}_{1}^i$] (UI1) at (5,-17) {};
    \node[vert,label=right:$\hat{u}_{2}^i$] (UI2) at (5,-19) {};
    \node (A) at (5,-20.5) {$\vdots$};
    \node[vert,label=right:$\hat{u}_{n+3}^i$, fill=gray] (UIN3) at (5,-22) {};
    \node (A) at (5,-24) {$\vdots$};
    \node[vert,label=right:$v_{k}^i$, fill=gray] (VIK) at (5,-26) {};
    ...
    \draw[edge] (VH11) --node[timelabel] {$n^5$} (VH12);
	\draw[edge] (VH12) --node[timelabel] {$n^5+1$} (VH13);
	
    \draw[edge] (VH21) --node[timelabel] {$n^5$} (VH22);
	\draw[edge] (VH22) --node[timelabel] {$n^5+1$} (VH23);
 
    \draw[edge] (VH31) --node[timelabel] {$n^5$} (VH32);
	\draw[edge] (VH32) --node[timelabel] {$n^5+1$} (VH33);
	...
	\draw[edge] (VH11) --node[timelabel] {$n^5$} (W2);
	\draw[edge] (VH21) edge[bend left=15] node[timelabel] {$n^5$} (W3);
	\draw[edge] (VH31) --node[timelabel] {$n^5$} (W4);
 
	\draw[edge] (VII1) --node[timelabel] {$t'$} (UI1);
	\draw[edge] (UI1) --node[timelabel] {$t'+2$} (UI2);
\end{tikzpicture}
    \end{center}
    \caption{...}\label{fig:hardness1}
\end{figure}

This finishes the construction of the \deltaExactLong\ instance, which can clearly be computed in polynomial time. For an illustration see \cref{fig:hardness1}. As discussed earlier, we have that the vertex cover number of the underlying graph of the instance is in $O(k^2)$.

\emph{Correctness.} In the remainder we prove that $D$ is a yes-instance of \deltaExactLong\ if and only if the $H$ is a yes-instance of \textsc{Multicolored Clique}.
...
\begin{claim}\label{claim:2}
    Let $\hat{v}_0$, $\hat{v}_1$, and $\hat{v}_2$ be the vertices of a connector gadget with sets $A$ and $B$. Then we have the following:
    \begin{itemize}
        \item $\lambda(\{\hat{v}_0,\hat{v}_1\})=n^5$.
        \item $\lambda(\{\hat{v}_1,\hat{v}_2\})=n^5+1$.
        \item For all $v\in V^\star$ we have $n^5\le \lambda(\{\hat{v}_1,v\}), \lambda(\{\hat{v}_2,v\})\le n^5+2$.
        %\item For all $v\in A\setminus B$ we have $\lambda(\{\hat{v}_1,v\})=n^5$ and $\lambda(\{\hat{v}_2,v\})=n^5+2$.
        %\item For all $v\in B$ we have $\lambda(\{\hat{v}_1,v\})=n^5$ and $\lambda(\{\hat{v}_2,v\})=n^5$.
        %\item For all $v\in V^\star \setminus A$ we have $\lambda(\{\hat{v}_1,v\})=n^5+2$ and $\lambda(\{\hat{v}_2,v\})=n^5+2$.
    \end{itemize}
\end{claim}
\begin{claimproof}
    Let $w\in \hat{W}$ denote the vertex of the alignment gadget that is neighbor of $w^\star$ and $\hat{v}_0$. We have $d(w^\star,\hat{v}_0)=n^5$. It follows that $\lambda(\{w,\hat{v}_0\})=n^5$. Since $d(\hat{v}_1,w)=\infty$ and $d(w,\hat{v}_1)=\infty$, we have that $\lambda(\{\hat{v}_0,\hat{v}_1\})=n^5$.
    Note that $\hat{v}_1$ is the only common neighbor of $\hat{v}_0$ and $\hat{v}_2$. Since $d(\hat{v}_0,\hat{v}_2)=2$ we have that $\lambda(\{\hat{v}_1,\hat{v}_2\})=n^5+1$.

    %Let $v\in B$. Note that $d(\hat{v}_0,v)=\infty$ and $d(v,\hat{v}_0)=\infty$. It follows that $\lambda(\{\hat{v}_1,v\})=n^5$.
Let $v\in V^\star$. Note that $d(v,\hat{v}_0)=\infty$. It follows that $\lambda(\{\hat{v}_1,v\})\ge n^5$.
\end{claimproof}
\end{proof}
